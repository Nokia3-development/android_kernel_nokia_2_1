...
const bqfs_cmd_t bqfs_scud[] = {
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x43, 0x9D, 0x00, 0x00, 0x00, 0x81, 0x0F, 0xA0, 0x3A, 0x98, 0x0C, 0xE4, 0x00, 0xC8, 0x00, 0x32, 0x00, 0x14, 0x03, 0xE8, 0x01, 0x00, 0xC8, 0x00, 0x0A, 0xFF, 0xCE, 0xFF, 0xCF, 0x00, 0x02, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
...
const bqfs_cmd_t bqfs_mcnair[] = {
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x44, 0x77, 0x00, 0x00, 0x00, 0x81, 0x0F, 0xA0, 0x3A, 0x98, 0x0C, 0xE4, 0x00, 0xC8, 0x00, 0x32, 0x00, 0x14, 0x03, 0xE8, 0x01, 0x00, 0xC8, 0x00, 0x0A, 0xFF, 0xD2, 0xFF, 0xD3, 0x00, 0x03, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
